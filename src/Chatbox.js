...
function Chatbox(){
    ...
    function getBotResponse(input) {
        if (input==="Hello") {
        ...
        } else if (input==="I Love Infinity Car-Bazar") {
            ...
            reply.push("You can mail us at infinitycarbazar@gmail.com ");
        } else if (input==="bike") {
            reply.push("You can click the view Bikes by Brand on this website Home page");
        } else if (input==="Bike") {
            reply.push("You can click the view Bikes by Brand on this website Home page");
        } else if (input==="car") {
            reply.push("You can click the view Cars by Brand on this website Home page; If confused you can even use the Recomendation Feature of our website  😉");
        } else if (input==="Car") {
            reply.push("You can click the view Cars by Brand on this website Home page; If confused, you can even use the Recomendation Feature of our website  😉");
        }
